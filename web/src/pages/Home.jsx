                ...
                <div className="rounded-2xl bg-[#0b0e1a] overflow-hidden">
                  ...
                  <div className="h-11 bg-[#0f1225]/90 border-b border-white/[0.06] flex items-center px-5 gap-3">
                    ...
                    <div className="flex-1 flex justify-center">
                      <div className="h-6 px-4 rounded-md bg-[#1a1d35]/80 border border-white/[0.05] flex items-center gap-2 text-xs text-slate-400">
                  ...
                  <div className="flex" style={{ minHeight: '520px' }}>
                    ...
                    <div className="w-[200px] bg-[#0a0d1a]/80 border-r border-white/[0.04] p-4 hidden md:flex flex-col gap-1 shrink-0">
                      ...
                      <div className="mt-auto pt-4 border-t border-white/[0.04] flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs text-slate-500 hover:text-slate-400 cursor-pointer transition-colors">
                    ...
                    <div className="flex-1 p-5 md:p-6 overflow-hidden">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500 mt-0.5">{currentTime} • {new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}</p>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="relative">
                            ...
                            <input
                              placeholder="Search..."
                              className="w-40 h-8 rounded-lg bg-white/[0.04] border border-white/[0.06] pl-8 pr-3 text-xs text-white/60 placeholder:text-slate-600 outline-none focus:border-blue-500/30 transition-colors"
                            />
                          </div>
                          <div className="relative">
                            <Bell className="w-4 h-4 text-slate-500 hover:text-slate-300 cursor-pointer transition-colors" />
                            ...
                            {timeEntries.map((entry, i) => (
                              <div key={i} className="flex items-center gap-2.5 py-1.5 border-b border-white/[0.03] last:border-0">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="text-[9px] text-slate-500 truncate">{entry.project}</div>
                                </div>
