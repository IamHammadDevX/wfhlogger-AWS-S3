  ...
  return (
    <div className="space-y-8">
      <div className="text-center max-w-2xl mx-auto pt-8">
        ...
        <a 
          href={downloadUrl}
          className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 text-white text-lg font-semibold px-8 py-4 rounded-xl shadow-lg shadow-blue-500/30 transition-all transform hover:-translate-y-1"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm text-center transition-colors">
          ...
          <h3 className="font-bold text-slate-900 dark:text-white mb-2">Instant Setup</h3>
          <p className="text-sm text-slate-600 dark:text-slate-400">Download, install, and sign in. No complex configuration required.</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm text-center transition-colors">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">End-to-end encryption for screenshots and activity data.</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm text-center transition-colors">
          ...
          <h3 className="font-bold text-slate-900 dark:text-white mb-2">Auto Updates</h3>
          <p className="text-sm text-slate-600 dark:text-slate-400">Always run the latest version with automatic background updates.</p>
        </div>
      </div>
    </div>
  )
